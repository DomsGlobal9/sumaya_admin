...
const Sidebar = ({ activeTab, setActiveTab }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-6 left-6 right-6">
        <button 
          className="w-full flex items-center cursor-pointer justify-center px-4 py-3 border border-red-300 text-red-600 rounded-lg hover:bg-red-50 transition-colors" 
...
// Top Navigation Component
const TopNavbar = ({ searchQuery, setSearchQuery, activeTab }) => {
  const [open, setOpen] = useState(false);
  const navigate = useNavigate();
  ...
  // Show search bar only on products tab
  const showSearch = activeTab === "products";
  ...
  const moderationData = [
    {
      id: 1,
      title: "Anarkali Cotton Kurti - Pink Floral",
      description: "Elegant hand-stitched Anarkali kurti in soft cotton, perfect for festive wear.",
      submitter: "Stylellilah Tailors",
      timeAgo: "2 hours ago",
      priority: "High",
      status: "Pending",
    },
    {
      id: 2,
      title: "Embroidered Georgette Kurti - Mint Green",
      description: "Delicate hand embroidery on lightweight georgette, perfect for casual or office wear.",
      submitter: "Meera's Boutique",
      timeAgo: "1 hours ago",
      priority: "Medium",
      status: "Pending",
    },
    {
      id: 3,
      title: "Cotton Kurta - Indigo Print",
      description: "Handblock printed cotton kurta with a relaxed fit and wooden buttons.",
      submitter: "Ubhandkala Tailoring",
      timeAgo: "30 mins ago",
      priority: "Low",
      status: "Pending",
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case "payouts":
        return <PayoutsContent />;
      case "products":
        return <ProductsContent searchQuery={searchQuery} />;
      case "add-product":
        return <AddProductContent />;
      default:
        return <MarketplaceContent />;
